...
from configcovid19newconddataframeCopy1 import *
...
class DataLoader():
    def __init__(self, dataset_path, normdata_path, img_res=None):
        ...
        if img_res is not None:
            ...
            self.img_res = configcovid19newconddataframeCopy1['cube_size']
    ...
    def load_data(self, batch_size=1, is_testing=False):
        #noise level to add for poisson noise 
        #NOISE=10
        ...
        for i, img in enumerate(batch_images):
            ...
            #noisy = np.random.poisson(img / 255.0 * NOISE) / NOISE * 255
